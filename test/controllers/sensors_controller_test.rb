...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { cleared: @sensor.cleared, cleared_at: @sensor.cleared_at, sensor_id: @sensor.sensor_id }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { cleared: @sensor.cleared, cleared_at: @sensor.cleared_at, sensor_id: @sensor.sensor_id }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
